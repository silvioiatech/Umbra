...
# NOTE: For persistent data on Railway, configure a Railway Volume to mount at /app/data externally.
...
# 2. (Optional) Add a Railway Volume mounted at /app/data if persistence needed.
