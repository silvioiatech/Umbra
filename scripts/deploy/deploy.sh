...
echo "   MCP Service:      http://localhost:8085 (local dev only - external in production)"
echo "   Concierge:        http://localhost:9090"
echo ""
echo "🔍 Health Checks:"
...
echo "   3. For Railway: Configure external MCP service URL"
echo "   4. VPS: Set up n8n instances only (not Concierge)"
